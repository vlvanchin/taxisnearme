...
(function(a) {
	...
	a.maskElement = function(d, c) {
		...
		if (c !== undefined) {
			...
			var b = a('<span class="loadmask-msg-alt" style="display:none;"><span class="fa fa-spinner fa-spin fa-3x fa-fw"></span></span>');
			//b.append("<span class='margin'>" + c + "</span>");
			b.append("<span>" + c + "</span>");
			d.append(b);
	...
	a.unmaskElement = function(b) {
		...
		b.find(".loadmask-msg-alt,.loadmask").remove();
